...
pub fn game_over_initiator(mut commands: Commands, hp: Res<HP>, app_state: Res<State<AppState>>, sim_state: Res<State<SimulationState>>) {
...
pub fn spawn_game_over(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    commands.spawn((
        SpriteBundle {
            ...
            texture: asset_server.load("sprites/gameoverscreen.png"),
